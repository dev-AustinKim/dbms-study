...
public class Test {
	public static void main(String[] args) {
		...
		//    userVO.setUserIdentification("kdh1234");
		//    userVO.setUserName("김동한");
		//    userVO.setUserPassword("3333");
		//    userVO.setUserAddress("서울특별시 강동구");
		//    userVO.setUserBirth("1998-04-12");
		//    userVO.setUserEmail("kdh1234@gmail.com");
		//    userVO.setUserPhone("01011112222");
		//    userVO.setUserRecommenderId("lss1234");

		//    userVO.setUserIdentification("ymw1234");
		//    userVO.setUserName("윤민우");
		//    userVO.setUserPassword("8888");
		//    userVO.setUserAddress("서울특별시 동작구");
		//    userVO.setUserBirth("1999-08-12");
		//    userVO.setUserEmail("ymw1234@gmail.com");
		//    userVO.setUserPhone("01033334444");
		//    userVO.setUserRecommenderId("lss1234");
		...
		//      로그인 상태에서 팔로우하기, 이미 팔로우 했다면 다시 팔로우하지 못함.
		if (followDAO.checkFollow(48L)) {
			//    로그인 했을 때 내가 팔로우하는 경우 나의 팔로잉 수 증가, 매개변수의 팔로워 수 증가 
			followDAO.followCount(48L);
			followDAO.insert(48L);
		} else {
			System.out.println("이미 팔로우했습니다. 언팔합니다.");
			followDAO.delete(48L);
		}


		//      내가 팔로우한 사람들
		//      followDAO.following().stream().map(UserVO::toString).forEach(System.out::println);


		//      나를 팔로우한 사람들
		//      followDAO.follower().stream().map(UserVO::toString).forEach(System.out::println);

		//      팔로워 아이디랑 팔로잉 아이디 두 개를 받아서 각각 팔로잉 수 증가, 팔로워 수 증가.
		//      followDAO.followCount(49L, 48L);
